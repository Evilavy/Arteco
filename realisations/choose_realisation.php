...
<a href="../admin.html" style="position: absolute; top: 20px; left: 20px;"><img style="height: 40px;" src="../assets/Menu.png" alt=""></a>
    ...
    <div class="container">
        <div class="card" onclick="window.location='write_new_realisation.php'">
            <div class="card-header">Ajouter</div>
            <div class="card-content"><a href="write_new_realisation.php">Ajouter une réalisation</a></div>
        </div>
        <div class="card" onclick="window.location='consult_realisations.php'">
            <div class="card-header">Consulter</div>
            <div class="card-content"><a href="consult_realisations.php">Consulter les réalisations</a></div>
        </div>
    </div>
