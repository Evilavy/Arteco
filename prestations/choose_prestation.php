...
<a href="../admin.html" style="position: absolute; top: 20px; left: 20px;"><img style="height: 40px;" src="../assets/Menu.png" alt=""></a>
    ...
    <div class="container">
        <div class="card" onclick="window.location='add_prestation.php'">
            <div class="card-header">Ajouter</div>
            <div class="card-content"><a href="add_prestation.php">Ajouter une prestation</a></div>
        </div>
        <div class="card" onclick="window.location='consult_prestation.php'">
            <div class="card-header">Consulter</div>
            <div class="card-content"><a href="consult_prestation.php">Consulter les prestations</a></div>
        </div>
    </div>
